...
const caseStudies: CaseStudy[] = [
  {
    ...
    challenge:
      "环球地产集团拥有多处优质商业地产，但面临资产流动性不足、投资门槛高和管理成本高的挑战。他们希望通过区块链技术将商业地产资产数字化，降低投资门槛，提高流动性。",
    solution:
      "StableTrust 提供了一站式商业地产代币化解决方案，将价值 50 亿元的商业地产项目分割为数字代币，实现资产的部分所有权、自动化管理和二级市场交易。方案包括资产评估、法律合规、智能合约开发、资产上链、代币发行与管理等全流程服务。",
    results: [
      "投资门槛从 500 万元降至 1 万元",
      "资产流动性提升 300%",
      "运营管理成本降低 40%",
    ...
    testimonial: {
      quote:
        "StableTrust 的区块链解决方案彻底改变了我们管理商业地产的方式，不仅大幅提升了资产流动性，还为我们带来了全新的投资者群体。",
      author: "王总",
      position: "环球地产集团 CEO",
    },
  },
  {
    ...
    challenge:
      "东方艺术基金拥有多件价值连城的艺术珍品，希望通过区块链技术实现艺术品所有权的部分共享，让更多艺术爱好者能够参与收藏，同时保证艺术品的真实性和所有权的安全性。",
    solution:
      "StableTrust 开发的艺术品数字化解决方案，通过区块链技术为每件艺术品创建唯一的数字身份，实现艺术品的所有权代币化。系统内置艺术品真实性验证机制、智能分红合约和二级市场交易平台，确保所有权分享的安全与透明。",
    results: [
      "艺术品价值评估提高 20%",
      "参与收藏的投资者增长 10 倍",
      "艺术品交易的透明度大幅提升",
  ...
  },
  {
    ...
    challenge:
      "亚太商品交易所面临大宗商品交易中的信任问题、结算周期长和欺诈风险高等挑战，希望利用区块链技术建立透明可信的大宗商品交易与溯源平台。",
    solution:
      "StableTrust 为其打造了基于区块链的大宗商品交易平台，实现从原产地到终端消费的全流程溯源。系统集成商品验证、智能合约自动结算、多方共识机制等功能，大幅提升交易效率和信任度。",
    results: [
      "交易结算周期从平均7天减少至 24 小时内",
      "纠纷率下降 90%",
      "运营成本降低 45%",
      "交易量增长 200%",
      "新增国际贸易伙伴 30 家",
    ...
    testimonial: {
      quote:
        "StableTrust 的区块链解决方案彻底革新了我们的大宗商品交易流程，交易变得更加透明、高效，极大地提升了我们在国际市场的竞争力。",
      author: "张总",
      position: "亚太商品交易所董事长",
    },
  },
  {
    ...
    challenge:
      "汇通金融集团在供应链金融业务中面临信息不对称、风险管控难和融资成本高等问题，急需提升供应链金融业务的透明度和效率。",
    solution:
      "StableTrust 开发的供应链金融区块链平台，将核心企业、上下游供应商、金融机构等多方纳入统一的区块链网络，实现贸易单据的数字化、资产的实时监控和智能合约自动放款，建立起高效透明的供应链金融生态。",
    results: [
      "中小企业融资成本降低 30%",
      "融资审批时间从 7 天缩短到 1 天",
      "坏账率下降 50%",
  ...
  },
  {
    ...
    challenge:
      "绿色未来联盟希望建立可信的碳资产监测、核算和交易平台，解决碳资产交易中存在的数据可信度低、监管难和交易效率低等问题。",
    solution:
      "StableTrust 开发的碳资产区块链平台实现了碳排放数据的实时采集、多方验证和加密存储，建立起可信的碳资产生成机制。平台同时支持碳资产的代币化和交易，满足不同行业的碳中和需求。",
    results: [
      "碳资产数据可信度大幅提升",
      "碳资产交易效率提高 200%",
      "碳资产流动性显著增强",
  ...
  },
  {
    ...
    challenge:
      "远景投资基金在私募股权投资管理中面临信息透明度不足、投资者报告复杂和二级交易难等问题，寻求通过区块链技术优化私募股权管理流程。",
    solution:
      "StableTrust 提供的私募股权数字化平台，将投资协议、资金流向、项目进展等关键信息上链，通过智能合约实现自动分红、投票和报告生成，并建立私募股权二级交易市场，提高投资透明度和流动性。",
    results: [
      "管理运营成本降低 35%",
      "投资者满意度提升 40%",
      "私募股权流动性提高 150%",
    ...
    testimonial: {
      quote:
        "借助 StableTrust 的区块链技术，我们彻底改变了私募股权投资的管理模式，投资者获得了前所未有的透明度和流动性，这是私募行业的一次革命。",
      author: "李总",
...
const CaseStudiesPage = () => {
  ...
  return (
    <>
      <PageHeader
        title="案例研究"
        subtitle="探索 StableTrust 如何帮助客户实现资产数字化转型"
              ...
              >
                ...
                <div className="p-6">
                  <div className="flex justify-between items-start mb-3">
                    ...
                    <span className="bg-muted text-primary text-sm px-2 py-1 rounded-full">
                      {caseStudy.industry}
                    </span>
                  </div>
              ...
              <div>
                ...
                {caseStudy.testimonial && (
                  <div className="bg-white p-6 rounded-lg shadow-md">
                    <p className="text-gray-700 font-opensans italic mb-4">
      ...
      <section className="py-16 bg-primary text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl font-opensans mb-8 max-w-3xl mx-auto">
            联系我们，了解 StableTrust 如何为您的业务提供定制化的 RWA 区块链解决方案
          </p>
          <a
            href="/contact"
