...
const executives = [
  ...
  },
  {
    ...
    bio: "区块链架构专家，拥有计算机科学博士学位，曾在硅谷顶级科技公司担任高级技术职位。李明博士主导了StableTrust核心技术平台的架构设计与研发，拥有多项区块链技术专利。",
    linkedin: "#"
  },
  {
    name: "王芳",
    ...
    bio: "拥有MBA学位和丰富的战略咨询经验，曾在国际管理咨询公司任职高级合伙人。王芳女士在StableTrust负责公司整体运营与业务拓展，建立了高效的组织架构与运营体系。",
    linkedin: "#"
  }
];
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            <p className="text-lg text-gray-700 font-opensans">
              StableTrust由行业资深专家领衔，拥有丰富的区块链技术与金融行业经验，为客户提供最专业的服务与支持。
            </p>
          </div>
              ...
              <div key={index} className="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-xl transition-shadow duration-300">
                ...
                <div className="p-6">
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <a href={exec.linkedin} className="text-primary hover:text-primary/80 transition-colors">
                      <Linkedin size={20} />
                    </a>
                  </div>
          ...
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            <p className="text-lg text-gray-700 font-opensans">
              我们的核心团队由区块链技术、金融、产品设计等领域的专业人才组成，为StableTrust的创新与发展提供坚实支持。
            </p>
          </div>
          
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
            {teamMembers.map((member, index) => (
              <div key={index} className="bg-muted rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-300 text-center">
      ...
      <section className="py-16 bg-muted">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg text-gray-700 font-opensans mb-8 max-w-3xl mx-auto">
            StableTrust始终寻找优秀的人才加入我们的团队。如果您热爱区块链技术，
